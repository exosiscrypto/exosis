...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            // FXTC END
            // EXOSIS BEGIN
            case SPORK_EXOSIS_01_FXTC_CHAIN_START:                    r = SPORK_EXOSIS_01_FXTC_CHAIN_START_DEFAULT; break;
            case SPORK_EXOSIS_02_UNLIMITED_BLOCK_SUBSIDY_START:       r = SPORK_EXOSIS_02_UNLIMITED_BLOCK_SUBSIDY_START_DEFAULT; break;
            case SPORK_EXOSIS_03_NO_SUBSIDY_HALVING_START:            r = SPORK_EXOSIS_03_NO_SUBSIDY_HALVING_START_DEFAULT; break;
            // EXOSIS END
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        // FXTC END
        // EXOSIS BEGIN
        case SPORK_EXOSIS_01_FXTC_CHAIN_START:                    return SPORK_EXOSIS_01_FXTC_CHAIN_START_DEFAULT;
        case SPORK_EXOSIS_02_UNLIMITED_BLOCK_SUBSIDY_START:       return SPORK_EXOSIS_02_UNLIMITED_BLOCK_SUBSIDY_START_DEFAULT;
        case SPORK_EXOSIS_03_NO_SUBSIDY_HALVING_START:            return SPORK_EXOSIS_03_NO_SUBSIDY_HALVING_START_DEFAULT;
        // FXTC END
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    // FXTC END
    // EXOSIS BEGIN
    if (strName == "SPORK_EXOSIS_01_FXTC_CHAIN_START")                    return SPORK_EXOSIS_01_FXTC_CHAIN_START;
    if (strName == "SPORK_EXOSIS_02_UNLIMITED_BLOCK_SUBSIDY_START")       return SPORK_EXOSIS_02_UNLIMITED_BLOCK_SUBSIDY_START;
    if (strName == "SPORK_EXOSIS_03_NO_SUBSIDY_HALVING_START")            return SPORK_EXOSIS_03_NO_SUBSIDY_HALVING_START;
    // EXOSIS END
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        // FXTC END
        // EXOSIS BEGIN
        case SPORK_EXOSIS_01_FXTC_CHAIN_START:                    return "SPORK_EXOSIS_01_FXTC_CHAIN_START";
        case SPORK_EXOSIS_02_UNLIMITED_BLOCK_SUBSIDY_START:       return "SPORK_EXOSIS_02_UNLIMITED_BLOCK_SUBSIDY_START";
        case SPORK_EXOSIS_03_NO_SUBSIDY_HALVING_START:            return "SPORK_EXOSIS_03_NO_SUBSIDY_HALVING_START";
        // EXOSIS END
        default:
