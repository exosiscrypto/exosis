...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Exosis address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Exosis: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Exosis addresses to prove you own them"));
    ...
    openAction->setStatusTip(tr("Open a Exosis: URI or payment request"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Exosis network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
void BitcoinGUI::updateHeadersSyncProgressLabel()
{
    ...
    int estHeadersLeft = (GetTime() - headersTipTime) / Params().GetConsensus().nPowTargetSpacingFix;
...
{
    QString strTitle = tr("Exosis"); // default title
