        ...
        LOCK(cs_wallet);
        {
            ...
            while (true)
            {
                ...
                if (nChange > 0)
                {
                    ...
                    // EXOSIS TODO: aligned to left because of original Bitcoin Core code compatibility
                    // Fill a vout to ourself
                    ...
                    // EXOSIS TODO: end of compatibility alignement
                    }
                } else {
                    nChangePosInOut = -1;
                }
...
/* EXOSIS TODO: must be implemented before instantsend activation
                // Dash
