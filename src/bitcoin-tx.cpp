...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s exosis-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  exosis-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded exosis transaction") + "\n" +
              "  exosis-tx [options] -create [commands]   " + _("Create hex-encoded exosis transaction") + "\n" +
              "\n";
