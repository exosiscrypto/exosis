...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " exosis-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  exosis-tx [options] <hex-tx> [commands]  Update hex-encoded Exosis transaction\n" +
            "or:     exosis-tx [options] -create [commands]   Create hex-encoded Exosis transaction\n" +
            "\n";
