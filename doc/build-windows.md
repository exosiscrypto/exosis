...
and is the platform used to build the Exosis Core Windows release binaries.
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/exosiscrypto/exosis.git
    sudo chmod -R a+rw exosis
