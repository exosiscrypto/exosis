...
* exosis.conf: contains configuration settings for exosisd or exosis-qt
* exosisd.pid: stores the process id of exosisd while running
...
* debug.log: contains debug information and general logging generated by exosisd or exosis-qt
